...
class Invoice(models.Model):
	...
	line_two = models.ForeignKey(Inventory, on_delete=models.SET_NULL, related_name='+',  verbose_name="Line 2", blank=True, default='', null=True)
	...
	line_three = models.ForeignKey(Inventory, on_delete=models.SET_NULL, related_name='+',  verbose_name="Line 3", blank=True, default='', null=True)
	...
	line_four = models.ForeignKey(Inventory, on_delete=models.SET_NULL,related_name='+',  verbose_name="Line 4", blank=True, default='', null=True)
	...
	line_five = models.ForeignKey(Inventory, on_delete=models.SET_NULL, related_name='+',  verbose_name="Line 5", blank=True, default='', null=True)
	...
	line_six = models.ForeignKey(Inventory, on_delete=models.SET_NULL, related_name='+',  verbose_name="Line 6", blank=True, default='', null=True)
	...
	line_seven = models.ForeignKey(Inventory, on_delete=models.SET_NULL, related_name='+',  verbose_name="Line 7", blank=True, default='', null=True)
	...
	line_eight = models.ForeignKey(Inventory, on_delete=models.SET_NULL, related_name='+',  verbose_name="Line 8", blank=True, default='', null=True)
	...
	line_nine = models.ForeignKey(Inventory, on_delete=models.SET_NULL, related_name='+',  verbose_name="Line 9", blank=True, default='', null=True)
	...
	line_ten = models.ForeignKey(Inventory, on_delete=models.SET_NULL, related_name='+',  verbose_name="Line 10", blank=True, default='', null=True)
